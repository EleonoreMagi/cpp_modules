      ...
      _target("no_target")
{
    ...
    {
        throw GradeTooLowException("Exception in the constructor. The grade is too low");
    }
    if (signGrade < 1 || execGrade < 1)
    {
        throw GradeTooHighException("Exception in the constructor. The grade is too high");
    }
}
...
{
    os << "name: " << a.getName() << \
          ", signStatus: " << a.getSignStatus() <<\
          ", grade reqired to sign: " << a.getSignGrade() << \
          ", greade required to execute: " << a.getExecGrade() << \
          ", target: " << a.getTarget();
    return os;
}
